    ...
    while time.time() < tempo:
        ...
        if 700 < c < 2700 or 230 < c < 350:
            ...
            if 700 < c < 2700 or 230 < c < 350:
                ...
                c = sensor_cor.value()
                if 350 < c < 700 or c < 230:
                    pegou_a_bolinha()
                    return
                else:
                    while 700 < c < 2700 or 230 < c < 350:
                        pegar_objeto_posicao()
                        c = sensor_cor.value()
        ...
        elif viu_preto[0] or viu_verde[0] or viu_vermelho[0]:
            tempo_total = time.time()
            tank_drive.on_for_seconds(SpeedPercent(0), SpeedPercent(0),0.01)
